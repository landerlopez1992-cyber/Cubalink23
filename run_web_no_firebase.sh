...
# 🚀 SCRIPT PARA EJECUTAR WEB SIN FIREBASE (SIN GRADLE)
# Versión que evita los errores de Firebase

echo "🚀 CUBALINK23 - WEB SIN FIREBASE EN MOTOROLA"
echo "============================================="
...
echo ""
echo "🚀 Iniciando servidor web (sin Firebase)..."

# Ejecutar en modo web sin Firebase
flutter run -d chrome --web-hostname=0.0.0.0 --web-port=8080 --no-sound-null-safety
