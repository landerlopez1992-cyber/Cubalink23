...
echo "📱 CubaLink23 - Solo Modo Móvil (412x915)"
echo "=========================================="
echo ""
...
echo "🔥 Iniciando Flutter SIN abrir navegador automáticamente..."
echo "⏳ Esto puede tomar unos segundos..."

# Iniciar Flutter en background SIN abrir navegador
flutter run -d chrome --web-port 8080 --no-web-browser-launch &
FLUTTER_PID=$!
...
# Abrir SOLO Chrome en modo móvil
