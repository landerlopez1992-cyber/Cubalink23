...
echo "📱 CubaLink23 - Solución Perfecta Móvil"
echo "======================================"
echo ""
...
echo "🔥 Iniciando Flutter con variables de entorno especiales..."
echo "⏳ Esto puede tomar unos segundos..."

# Configurar variables de entorno para evitar que Flutter abra Chrome automáticamente
...
echo "🧹 Cerrando cualquier Chrome que haya abierto Flutter..."
pkill -f "Google Chrome.*localhost:8080" 2>/dev/null || true

echo "⏳ Esperando 1 segundo..."
sleep 1

echo "📱 Abriendo SOLO Chrome en modo móvil..."
...
echo ""
echo "✅ ¡Listo! Solo Chrome móvil abierto"
