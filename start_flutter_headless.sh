...
echo "📱 CubaLink23 - Flutter Headless + Chrome Móvil"
echo "==============================================="
echo ""
...
# Iniciar Flutter en background con variables de entorno para evitar Chrome automático
...
# Esperar un poco más para asegurar que Flutter esté completamente listo
sleep 3
