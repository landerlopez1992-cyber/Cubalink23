    ...
    try {
      ...
      setState(() {
        _messages = [
          {
            'id': '1',
            'text': 'Hola, soy Jose Antonio, repartidor. Tengo una consulta sobre mi última entrega.',
            'isFromUser': true,
          ...
          {
            'id': '2',
            'text': 'Hola Jose! Soy María del equipo de soporte. ¿En qué puedo ayudarte?',
            'isFromUser': false,
          ...
          {
            'id': '3',
            'text': 'La orden ORD-12345 no pude entregarla porque el cliente no estaba en la dirección. ¿Qué debo hacer?',
            'isFromUser': true,
